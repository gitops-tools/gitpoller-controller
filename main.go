...
import (
	...
	"github.com/gitops-tools/gitpoller-controller/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7601f4ad.gitops.tools",
	})
	if err != nil {
	...
	if err = (&controllers.PolledRepositoryReconciler{
		Client:          mgr.GetClient(),
		Log:             ctrl.Log.WithName("controllers").WithName("PolledRepository"),
